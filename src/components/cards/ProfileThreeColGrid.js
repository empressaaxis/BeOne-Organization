...
const LinkContainer = tw.a`no-underline text-primary-500 hover:underline duration-300 ease-in`;
      ...
      <ContentWithPaddingXl>
        <HeadingContainer>
          ...
          {description && (
            <Description>
              Become a{" "}
              <LinkContainer href="https://react-admin-dashboard-lilac.vercel.app/beOneOrganisation/register-mentor">
                mentor
              </LinkContainer>
            </Description>
          )}
